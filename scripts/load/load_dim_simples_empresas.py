"""
Script de carga: Dim_Simples_Empresas
Etapa: Load
Fonte: files/clean/empresas_simples.csv
Destino: files/enrich/dim_simples_empresas.csv
...
CAMINHO_ORIGEM = RAIZ_PROJETO / "files" / "clean" / "empresas_simples.csv"
CAMINHO_DESTINO = RAIZ_PROJETO / "files" / "enrich" / "dim_simples_empresas.csv"


def carregar() -> None:
    print("[load] Gerando Dim_Simples_Empresas...")
