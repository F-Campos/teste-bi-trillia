"""
Script de carga: Dim_Cadastro_Empresas
Etapa: Load
Fonte: files/clean/df_empresas.csv
Destino: files/enrich/dim_cadastro_empresas.csv
...
CAMINHO_ORIGEM = RAIZ_PROJETO / "files" / "clean" / "df_empresas.csv"
CAMINHO_DESTINO = RAIZ_PROJETO / "files" / "enrich" / "dim_cadastro_empresas.csv"


def carregar() -> None:
    print("[load] Gerando Dim_Cadastro_Empresas...")
