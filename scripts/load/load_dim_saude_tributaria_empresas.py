"""
Script de carga: Dim_Saude_Tributaria_Empresas
Etapa: Load
Fonte: files/clean/empresas_saude_tributaria.csv
Destino: files/enrich/dim_saude_tributaria_empresas.csv
...
CAMINHO_ORIGEM = RAIZ_PROJETO / "files" / "clean" / "empresas_saude_tributaria.csv"
CAMINHO_DESTINO = RAIZ_PROJETO / "files" / "enrich" / "dim_saude_tributaria_empresas.csv"


def carregar() -> None:
    print("[load] Gerando Dim_Saude_Tributaria_Empresas...")
