"""
Script de carga: Dim_Atividade_Empresas
Etapa: Load
Fonte: files/clean/empresas_nivel_atividade.csv
Destino: files/enrich/dim_atividade_empresas.csv
...
CAMINHO_ORIGEM = RAIZ_PROJETO / "files" / "clean" / "empresas_nivel_atividade.csv"
CAMINHO_DESTINO = RAIZ_PROJETO / "files" / "enrich" / "dim_atividade_empresas.csv"


def carregar() -> None:
    print("[load] Gerando Dim_Atividade_Empresas...")
