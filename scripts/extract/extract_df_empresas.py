"""
Script de extração: df_empresas
Etapa: Extract
Fonte: files/spreadsheets/df_empresas.csv
Destino: files/raw/df_empresas.csv
...
COLUNAS_ESPERADAS = [
    "cnpj", "dt_abertura", "matriz.empresaMatriz", "cd_cnae_principal",
    "de_cnae_principal", "de_ramo_atividade", "de_setor", "endereco_cep",
