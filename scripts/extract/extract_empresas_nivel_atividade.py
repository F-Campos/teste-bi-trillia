"""
Script de extração: empresas_nivel_atividade
Etapa: Extract
Fonte: files/spreadsheets/empresas_nivel_atividade.csv
Destino: files/raw/empresas_nivel_atividade.csv
...
COLUNAS_ESPERADAS = ["cnpj", "nivel_atividade"]
