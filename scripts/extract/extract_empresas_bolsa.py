"""
Script de extração: empresas_bolsa
Etapa: Extract
Fonte: files/spreadsheets/empresas_bolsa.csv
Destino: files/raw/empresas_bolsa.csv
...
# Nome da base tratada por este script
NOME_BASE = "empresas_bolsa"

# Colunas esperadas na base original (para validação)
COLUNAS_ESPERADAS = [
    "id", "cd_acao_rdz", "nm_empresa", "setor_economico", "subsetor",
    "segmento", "segmento_b3", "nm_segmento_b3", "cd_acao",
    "tx_cnpj", "vl_cnpj", "created_at", "updated_at",
]

# Caminhos relativos à raiz do projeto (este script está em scripts/extract/)
