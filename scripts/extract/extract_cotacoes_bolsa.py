"""
Script de extração: cotacoes_bolsa
Etapa: Extract
Fonte: files/spreadsheets/cotacoes_bolsa.csv
Destino: files/raw/cotacoes_bolsa.csv
...
COLUNAS_ESPERADAS = [
    "id", "tp_reg", "dt_pregao", "cd_bdi", "cd_acao", "tp_merc",
    "nm_empresa_rdz", "especi", "prazot", "moeda_ref", "vl_abertura",
    "vl_maximo", "vl_minimo", "vl_medio", "vl_fechamento",
    "vl_mlh_oft_compra", "vl_mlh_oft_venda", "vl_ttl_neg", "qt_tit_neg",
    "vl_volume", "vl_exec_opc", "in_opc", "dt_vnct_opc", "ft_cotacao",
    "vl_exec_moeda_corrente", "cd_isin", "cd_acao_rdz", "created_at",
    "updated_at", "__index_level_0__",
]
