"""
Script de extração: empresas_simples
Etapa: Extract
Fonte: files/spreadsheets/empresas_simples.csv
Destino: files/raw/empresas_simples.csv
...
COLUNAS_ESPERADAS = ["cnpj", "optante_simples", "optante_simei"]
